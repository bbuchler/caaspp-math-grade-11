...
Media must teach a move students will use immediately. For this pilot, every video has a watch-for prompt and contextual questions below it.
...
- Link opens.
- Video title matches lesson.
- Video is not the only explanation.
